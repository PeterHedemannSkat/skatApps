...
import { tusindtalsSep,normalInput,bootstrapStyleRadioButton,wizardBar,selector } from '../../../shared/shared';
...
@NgModule({
  ...
  declarations: [ AppComponent, wizardBar, basicIncome, globalButtoms, normalInput, basicSkattekort, bootstrapStyleRadioButton, resultat, tusindtalsSep,selector, Aindkomst ],
  providers: [ appRoutingProviders, skattekortText, WizardState ],
